/* empty css                      */import{S as g,P as w}from"./assets/vendor-BlZH08zN.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const r of t.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&c(r)}).observe(document,{childList:!0,subtree:!0});function s(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function c(e){if(e.ep)return;e.ep=!0;const t=s(e);fetch(e.href,t)}})();let f=null;function p(i){var e,t,r;const o=i.pagination.bullets;o.forEach(n=>{n.classList.remove("bullet-large","bullet-medium","bullet-small")});const s=i.realIndex,c=o.length;(e=o[s])==null||e.classList.add("bullet-large"),(t=o[(s+1)%c])==null||t.classList.add("bullet-medium"),(r=o[(s+2)%c])==null||r.classList.add("bullet-small")}function m(){if(window.innerWidth>=1440){f&&(f.destroy(!0,!0),f=null);return}f||(f=new g(".available-swiper",{modules:[w],slidesPerView:1,spaceBetween:16,speed:600,pagination:{el:".available-pagination",clickable:!0},on:{init(o){p(o)},slideChange(o){p(o)}}}))}m();window.addEventListener("resize",m);document.querySelectorAll(".faq-acc-el-trigger").forEach(i=>{i.addEventListener("click",()=>{const o=i.closest(".faq-acc-el"),s=o.querySelector(".faq-acc-el-descr-frame"),c=i.querySelector("svg"),e=o.classList.contains("open"),t=`
